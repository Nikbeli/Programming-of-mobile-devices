...
abstract class AppLocale {
  ...
  /// **'Конфета добавлена в понравившиеся :)'**
  String get cardLiked;

  /// No description provided for @cardDisliked.
  ///
  /// In ru, this message translates to:
  /// **'Конфета удалена из понравившегося :('**
  ...
  /// No description provided for @titleCard.
  ///
  /// In ru, this message translates to:
  /// **'Название'**
  String get titleCard;

  /// No description provided for @descriptionCard.
  ///
  /// In ru, this message translates to:
  /// **'Описание'**
  String get descriptionCard;
